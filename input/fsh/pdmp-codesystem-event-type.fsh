...
* ^caseSensitive = false
* ^content = #complete
* #pdmp-patient-request "PDMP Patient Request" "Request for a single patient's PDMP information"
* #pdmp-patient-response "PDMP Patient Response" "Response containing a single patient's PDMP information"