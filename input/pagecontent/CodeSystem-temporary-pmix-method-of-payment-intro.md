...
<p>
 <b>Temporary code system.</b> This code system is a placeholder that is intended to be replaced with a reference to the <i>PMIX Method of Payment</i> code system once it has been incorporated into HL7 terminology. 
